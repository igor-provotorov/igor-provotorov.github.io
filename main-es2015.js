...
***************************************************************************** */
                ...
                let LocalStorageService = class LocalStorageService {
                    ...
                    setSavedState(payload) {
                        const actions =
                            ...
                            [];
                        const newActions = actions.concat(payload);
                    ...
                    removeFromState(payload) {
                        const actions = this.getSavedState(
                            _constants_index__WEBPACK_IMPORTED_MODULE_2__["FILMS_TO_WATCH_KEY"]
                        );
                        const newActions = actions.filter(movie => movie.id !== payload.id);
                        localStorage.setItem(
                            _constants_index__WEBPACK_IMPORTED_MODULE_2__["FILMS_TO_WATCH_KEY"],
                            JSON.stringify(newActions)
                        );
  ...
  !*** ./src/app/core/store/films-to-watch/index.ts ***!
  \****************************************************/
            /*! exports provided: FilmsToWatchActionTypes, AddFilmToWatchList, RemoveFilmFromWatchList, GetFilmsToWatch, GetFilmsToWatchSuccess, FilmsToWatchEffects, initialState, filmsToWatchReducer, selectFilmToWatchState, selectFilmToWatchList */
            /***/ function(module, __webpack_exports__, __webpack_require__) {
                "use strict";
                __webpack_require__.r(__webpack_exports__);
                /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
  ...
  !*** ./src/app/core/store/index.ts ***!
  \*************************************/
            /*! exports provided: reducers, FilmsToWatchActionTypes, AddFilmToWatchList, RemoveFilmFromWatchList, GetFilmsToWatch, GetFilmsToWatchSuccess, FilmsToWatchEffects, initialState, filmsToWatchReducer, selectFilmToWatchState, selectFilmToWatchList */
            /***/ function(module, __webpack_exports__, __webpack_require__) {
                "use strict";
                __webpack_require__.r(__webpack_exports__);
                /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
